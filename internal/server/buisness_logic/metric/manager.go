...
import (
	...
	valueHandlerFactory "github.com/oldhanasong/go-metrics-collector/internal/server/buisness_logic/metric/value_handler"
...
func prepareMetric(ctx context.Context, repos repository.Repository, metric generaldto.Metrics) (generaldto.Metrics, error) {
	...
	valueHandler, err := valueHandlerFactory.ValueHandler(metric)
	if err != nil {
		return generaldto.Metrics{}, err
	}
