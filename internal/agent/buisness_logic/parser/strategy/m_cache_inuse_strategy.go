...
func (strategy *MCacheInuseStrategy) ParseMetric(metric *dto.Metrics, metricData *agentDto.CollectedMetricData) error {
	...
	metric.MName = dictionary.MCacheInuseMetricName
	metric.Value = &value
