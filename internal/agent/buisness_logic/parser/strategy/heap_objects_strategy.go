...
func (strategy *HeapObjectsStrategy) ParseMetric(metric *dto.Metrics, metricData *agentDto.CollectedMetricData) error {
	...
	metric.MName = dictionary.HeapObjectsMetricName
	metric.Value = &value
