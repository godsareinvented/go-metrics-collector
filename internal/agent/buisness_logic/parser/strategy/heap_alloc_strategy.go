...
func (strategy *HeapAllocStrategy) ParseMetric(metric *dto.Metrics, metricData *agentDto.CollectedMetricData) error {
	...
	metric.MName = dictionary.HeapAllocMetricName
	metric.Value = &value
